...
static GLfloat l_diffuse[] = {0.8, 0.8, 0.8, 1.0};
static GLfloat l_ambient[] = {0.8, 0.0, 0.0, 1.0};
static GLfloat l_specular[] = {0.8, 0.8, 0.8, 1.0};

/* 物体の色 */
static GLfloat m_diffuse[] = {0.8, 0.8, 0.0, 1.0};
